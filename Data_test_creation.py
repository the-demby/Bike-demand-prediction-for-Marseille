...
download_dir = r"C:\Users\39812\OneDrive - Aix Marseille Provence Métropole\Documents\Bike Project\Datasets_test"
...
output_file = os.path.join(Dataset, "Data_test.csv")
combined_df.to_csv(output_file, index=False)

print(f"Le fichier Data_test.csv a été créé avec succès et enregistré dans {Dataset}")